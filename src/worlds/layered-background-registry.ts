...
const GALAXY: readonly LayeredBackgroundLayer[] = [
  layer("galaxy-sky", "galaxy/sky.svg", 0.12, 1, 1, 0.5, 0.5, -0.001, 0),
  layer("galaxy-nebula", "galaxy/nebula.svg", 0.22, 0.9, 1.08, 0.5, 0.35, 0.002, 0.0006, 0.0015),
  layer("galaxy-spiral", "galaxy/spiral.svg", 0.26, 0.86, 0.42, 0.79, 0.18, -0.0008, 0.0002, 0.012),
  layer("galaxy-planet", "galaxy/planet.svg", 0.34, 0.95, 0.31, 0.18, 0.24, 0.0013, 0.00025, 0.001),
  layer("galaxy-asteroids", "galaxy/asteroids.svg", 0.66, 0.78, 0.82, 0.5, 0.54, -0.007, 0.005, 0.006),
];
