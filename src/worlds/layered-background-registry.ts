...
const GALAXY: readonly LayeredBackgroundLayer[] = [
  layer(
    "galaxy-sky",
    "vendor/rawdanitsu/space-background-4.png",
    0.1,
    0.72,
    1.08,
    0.5,
  ...
  layer(
    "galaxy-starfield",
    "vendor/screaming-brain/starfield-4-512.png",
    0.16,
    0.18,
    1.45,
    0.5,
  ...
  layer(
    "galaxy-nebula",
    "vendor/screaming-brain/purple-nebula-3-512.png",
    0.2,
    0.16,
    1.5,
    0.56,
  ...
  layer(
    "galaxy-black-hole",
    "vendor/sparklinlabs/black-hole.png",
    0.34,
    0.34,
    0.19,
    0.78,
  ...
  layer(
    "galaxy-asteroid-near-left",
    "vendor/kenney/meteor-brown-big1.png",
    0.76,
    0.5,
    0.12,
    0.13,
  ...
  layer(
    ...
    "vendor/kenney/meteor-grey-med1.png",
    0.6,
    0.42,
    0.09,
    0.83,
