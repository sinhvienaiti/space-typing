...
Ship Visual V3 art polish: `docs/SHIP_VISUAL_V3_PERFORMANCE_FIRST_PLAN.md` is APPROVED and V30/V31 have a safe runtime/bundle-size preparation branch. V3 actual premium raster artwork, live browser/size/framerate verification and V32–V36 are PENDING; do not report the existing V2 vector sheet as premium V3 art. New V3 effects that materially affect performance or enemy-word readability should be simplified or omitted.\n\nImportant implementation notes:
