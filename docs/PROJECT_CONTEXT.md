...
Approved pre-M22 polish slice: `docs/PRE_M22_UI_RECALL_CHARACTER_POLISH_PLAN.md` P00-P08 must complete before the final manual matrix so the user tests the final title/HUD/learning/Recall Bonus/character visual state. M23 remains blocked until that manual gate passes.
~~~
